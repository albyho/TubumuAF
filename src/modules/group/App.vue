...
<el-container v-loading.fullscreen.lock="isLoading">
  ...
  <el-main class="main"> 
    ...
    <el-dialog :visible="mainFormDialogVisible" @submit.native.prevent :close-on-click-modal="false" width="600px">
      <span slot="title">
        {{ editActive ? '编辑' : '添加'}}
      </span>
    ...
    <el-dialog :visible="moveFormDialogVisible" @submit.native.prevent :close-on-click-modal="false" width="600px">
      <span slot="title">
